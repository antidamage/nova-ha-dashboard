...
const SECTION_FIELDS: Record<ThemeSectionKind, ReadonlyArray<keyof DeviceTheme>> = {
  themeColours: ["accent", "highlight", "background", "border", "headerFade", "titleColors", "clockColor", "ledColor", "titleTone", "voiceTranscriptColors", "lightingTint", "lightingTintStrength"],
