...
#
# Does NOT touch: the brave-nova autostart entry, brave-kiosk-guard.sh, or the
# guard timer — they already invoke these two files by path.
set -euo pipefail
...
for f in brave-kiosk-launch.sh kiosk-cdp-probe.py; do
